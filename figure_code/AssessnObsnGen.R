...
for (i in 1:n_tasks) {
  ...
  load(sprintf("/Users/hdirector/Dropbox/Contours/ContourPaperScripts/Simulations/sim_results/nObsnGen/task%iShape%snObs%inGen%i.rda",
