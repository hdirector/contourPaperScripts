...
colnames(task_table) <- c("n_obs", "n_gen")
...
task_table$err_prop <- c(p(1, 9), rep(1.5, 9), rep(1.75, 9)) #FIX ME!
...
##############################################################
#To do, repeat optimal setting with smoother and spikier case
##############################################################
