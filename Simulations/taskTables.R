...
task_table$p_prop <- rep(1.5, n_case)
...
task_table$p_test <- rep(100, n_case)
task_table$n_evals <- rep(50, n_case) 
task_table$n_grid <- c(rep(100, 12), rep(200, 6)) 
task_table$mu0 <- rep(.1, n_case)
task_table$Lambda0_sigma2 <- rep(.05, n_case)
task_table$betaKappa0 <- rep(100, n_case)
task_table$betaSigma0 <- rep(.1, n_case)
...
task_table$r1_min <- rep(0, n_case)
task_table$r1_max <- rep(.001, n_case)
task_table$r2_min <- rep(.001, n_case)
task_table$r2_max <- rep(.005, n_case)
task_table$n_curl_max <- task_table$n_curl_min + rep(c(1, 2), 3)
save(task_table, 
