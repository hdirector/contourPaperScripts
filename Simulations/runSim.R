...
save(res_cover, 
     file = sprintf("/homes/direch/contours/Simulations/sim_results/%s/task%iShape%snObs%inGen%i%f.rda",
                    task_name, task_id, task$shape_name, n_obs, n_gen, p_prop))
